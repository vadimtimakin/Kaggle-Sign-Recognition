...
class SSTCN_Pose_model(nn.Module):
    ...
    def __init__(self,frames_number,joints_number,n_classes=226):
        ...
        self.swish = swish()
        self.t1 = TemporalBlock(self.in_channels,frames_number,1,10)
        self.t2 = TemporalBlock(frames_number,self.final_frames_number,1,10,relu = False)
        self.f1 = SpatialBlock(self.final_frames_number*joints_number,
        self.final_frames_number*joints_number,joints_number,joints_number*10)
        self.f2 = SpatialBlock(self.final_frames_number*joints_number,
        self.final_frames_number*joints_number,joints_number,joints_number*10,relu = False)
        self.f3 = SpatialBlock(self.final_frames_number*joints_number,
        self.final_frames_number*joints_number,self.final_frames_number,self.final_frames_number*10)
        self.f4 = SpatialBlock(self.final_frames_number*joints_number,
        self.final_frames_number*joints_number,self.final_frames_number,self.final_frames_number*10, relu = False)
        self.f5 = SpatialBlock(self.final_frames_number*joints_number,
        self.final_frames_number*joints_number,1,10*10)
        self.f6 = SpatialBlock(self.final_frames_number*joints_number,30*joints_number,1,10*10)
